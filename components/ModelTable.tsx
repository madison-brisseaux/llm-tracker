                  ...
                  filtered.map(model => (
                    <tr key={model.id} className="hover:bg-[#FEEEED] transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        ...
                        {model.analysisLink && (
                          <a
                            href={model.analysisLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 mt-2 px-2.5 py-1 rounded-full text-[11px] font-semibold bg-[#F7594E]/10 text-[#F7594E] hover:bg-[#F7594E]/20 transition-colors whitespace-nowrap"
                          >
